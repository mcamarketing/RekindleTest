  ...
  return (
    <div className="min-h-screen bg-[#1A1F2E] relative overflow-hidden flex items-center justify-center px-6">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-[800px] h-[800px] bg-[#FF6B35] rounded-full blur-[150px] opacity-30 animate-aurora" />
        <div className="absolute bottom-1/4 left-1/4 w-[600px] h-[600px] bg-[#F7931E] rounded-full blur-[150px] opacity-25 animate-aurora" style={{ animationDelay: '3s' }} />
        <div className="absolute top-1/2 left-1/3 w-[700px] h-[700px] bg-purple-600 rounded-full blur-[150px] opacity-15 animate-aurora" style={{ animationDelay: '6s' }} />
      </div>
      ...
      <div className="glass-card p-10 w-full max-w-md animate-fade-in relative z-10">
        ...
        <h2 className="text-3xl font-bold text-white mb-3 text-center">Create your account</h2>
        <p className="text-gray-400 mb-8 text-center text-lg">Start reviving your leads today</p>
