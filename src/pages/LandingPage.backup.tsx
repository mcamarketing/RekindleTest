...
const Button = ({ children, primary = true, onClick }: { children: React.ReactNode; primary?: boolean; onClick?: () => void }) => {
  ...
  const baseClasses = 'px-10 py-5 font-bold text-lg rounded-full transition-all duration-500 transform hover:scale-[1.02] shadow-lg relative overflow-hidden group';
  const primaryClasses = 'bg-gradient-to-r from-[#FF6B35] via-[#FF7847] to-[#F7931E] text-white hover:shadow-[0_20px_60px_rgba(255,107,53,0.4),0_0_40px_rgba(255,107,53,0.3)] backdrop-blur-xl';
  const secondaryClasses = 'bg-white/5 border-2 border-white/20 text-white hover:bg-white/10 hover:border-white/30 backdrop-blur-xl';
  ...
  return (
    <button
      ...
      style={{
        transform: isHovered ? `perspective(1000px) rotateX(${(mousePosition.y - 25) * 0.1}deg) rotateY(${(mousePosition.x - 100) * 0.1}deg) scale(1.02)` : 'none',
        transition: 'transform 0.3s cubic-bezier(0.23, 1, 0.32, 1), box-shadow 0.3s ease'
      }}
    >
      {/* Magnetic glow effect - Stripe inspired */}
      {primary && isHovered && (
        <span
          className="absolute w-32 h-32 bg-gradient-radial from-white/40 via-white/20 to-transparent rounded-full blur-2xl transition-all duration-300 pointer-events-none"
          style={{
      ...
      {/* Linear-inspired subtle grid */}
      <span className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:20px_20px] opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
...
const SectionTitle = ({ eyebrow, children, subtitle }: { eyebrow?: string; children: React.ReactNode; subtitle?: string }) => (
  <div className="text-center mb-20 animate-fade-in-up">
    {eyebrow && (
      <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#FF6B35]/10 via-[#F7931E]/10 to-[#FF6B35]/10 border border-[#FF6B35]/20 backdrop-blur-xl mb-6 hover:scale-105 transition-transform duration-300">
        <span className="w-1.5 h-1.5 rounded-full bg-gradient-to-r from-[#FF6B35] to-[#F7931E] animate-pulse" />
        <span className="text-[#FF6B35] font-semibold text-xs uppercase tracking-[0.2em]">
          {eyebrow}
        </span>
      </div>
    )}
    <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 leading-[1.1] tracking-tight" style={{
      textShadow: '0 2px 40px rgba(255,107,53,0.2)'
    }}>
      {children}
    </h2>
    {subtitle && (
      ...
      <main className="pt-20">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="inline-flex items-center gap-2 px-6 py-3 glass-card rounded-full mb-8 border-2 border-orange-500/40 hover:scale-105 transition-all duration-300">
                  ...
                  <span className="text-white font-bold text-sm tracking-wide">🎯 EXCLUSIVE PILOT • 32 SPOTS LEFT • CLOSES DEC 31ST</span>
                </div>

                {/* SEATS PROGRESS BAR */}
                <div className="max-w-md mx-auto lg:mx-0 mb-8">
                  <div className="flex justify-between text-sm text-gray-400 mb-2">
                    <span>Pilot cohort filling up</span>
                    <span className="text-white font-bold">32/50 claimed</span>
                  </div>
                  <div className="h-3 bg-gray-700 rounded-full overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-orange-500 to-orange-600 rounded-full transition-all duration-1000" style={{ width: '64%' }} />
                  </div>
                </div>

                {/* HEADLINE - TIGHTER 2 LINES */}
                ...
                <div className="glass-card rounded-3xl p-8 border-2 border-orange-500/30 mb-8 max-w-md mx-auto lg:mx-0">
                  <div className="text-center">
                    ...
                    <div className="text-gray-300 text-sm space-y-2">
                      <div>✓ Zero platform fee first 30 days</div>
                      <div>✓ Pay only 2.5% ACV per meeting</div>
                      <div>✓ 5+ meetings guaranteed or £500 cash</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap justify-center lg:justify-start gap-4 mb-8">
                  {['SOC 2 Type II', 'GDPR Compliant', 'Invite-Only Pilot'].map((badge, idx) => (
                    <div key={badge} className="flex items-center gap-2 glass-card px-4 py-2 rounded-full border border-gray-600">
                ...
                {/* CTA BUTTONS - STRIPE QUALITY */}
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <button
                    onClick={() => navigate('/pilot-application')}
                    className="group relative bg-gradient-to-r from-[#FF6B35] to-[#F7931E] text-white px-12 py-6 rounded-2xl text-xl font-black hover:scale-105 transition-all shadow-[0_10px_40px_rgba(255,107,53,0.3)] hover:shadow-[0_20px_60px_rgba(255,107,53,0.5)]"
                  >
                    <span className="relative z-10 flex items-center justify-center gap-3">
                      🔥 Show Me My £500K—Get FREE Analysis
                      <ArrowRight className="w-6 h-6 group-hover:translate-x-1 transition-transform" />
                    </span>
                  </button>
                  
                  <button className="group bg-white/10 backdrop-blur-xl border-2 border-white/20 text-white px-8 py-6 rounded-2xl text-lg font-semibold hover:bg-white/20 hover:border-white/40 transition-all hover:scale-105">
                ...
                {/* PILOT COHORT LOGOS ROW */}
                <div className="mt-12">
                  <div className="text-center mb-4">
                    <span className="text-sm text-gray-400">Join 200+ B2B teams in pilot</span>
                  </div>
                  <div className="flex items-center justify-center gap-8 opacity-60 hover:opacity-80 transition-opacity">
                    {/* Anonymous placeholder logos */}
                    {['Company A', 'Company B', 'Company C', 'Company D', 'Company E'].map((company) => (
                      <div key={company} className="w-16 h-8 bg-gray-700 rounded flex items-center justify-center">
              ...
              {/* RIGHT SIDE: DASHBOARD HERO SCREENSHOT */}
              <div className="relative">
                {/* Dashboard Preview Placeholder */}
                <div className="relative">
                  <div className="glass-card rounded-3xl p-8 border-2 border-white/10 shadow-[0_20px_80px_rgba(0,0,0,0.3)]">
                    {/* Dashboard Mockup */}
                    <div className="bg-[#242938] rounded-2xl p-6 border border-gray-700">
                      ...
                      <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="text-white font-bold">Rekindle Dashboard</div>
                            <div className="text-gray-400 text-sm">Live Pipeline Recovery</div>
                          </div>
                        </div>
                      ...
                      <div className="grid grid-cols-3 gap-4 mb-6">
                        <div className="text-center p-4 bg-[#1A1F2E] rounded-xl border border-gray-700">
                          <div className="text-2xl font-black text-[#FF6B35] mb-1">4,250</div>
                          <div className="text-xs text-gray-400">Leads Recovered</div>
                        </div>
                        <div className="text-center p-4 bg-[#1A1F2E] rounded-xl border border-gray-700">
                          <div className="text-2xl font-black text-green-400 mb-1">647</div>
                          <div className="text-xs text-gray-400">Meetings Booked</div>
                        </div>
                        <div className="text-center p-4 bg-[#1A1F2E] rounded-xl border border-gray-700">
                          <div className="text-2xl font-black text-blue-400 mb-1">£547K</div>
                      ...
                      <div className="space-y-3">
                        ...
                        {[1, 2, 3].map((item) => (
                          <div key={item} className="flex items-center gap-3 p-3 bg-[#1A1F2E] rounded-lg border border-gray-700">
                            <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse" />
                            <div className="flex-1">
                              <div className="text-white text-sm">Meeting booked with TechCorp Ltd</div>
                              <div className="text-gray-400 text-xs">{item * 3} minutes ago</div>
                            </div>
                            <div className="text-green-400 text-sm font-semibold">£15K deal</div>
                          </div>
                        ))}
                      </div>
                    </div>
                  ...
                  <div className="absolute -top-4 -right-4 glass-card rounded-xl p-3 border-2 border-orange-500/30 animate-float">
                    <div className="flex items-center gap-2">
                      <CheckCircle className="w-5 h-5 text-green-400" />
                      <span className="text-white text-sm font-semibold">Trigger Detected</span>
                    </div>
                  </div>

                  <div className="absolute -bottom-4 -left-4 glass-card rounded-xl p-3 border-2 border-blue-500/30 animate-float" style={{ animationDelay: '1.5s' }}>
                    <div className="flex items-center gap-2">
                      <MessageSquare className="w-5 h-5 text-blue-400" />
                      <span className="text-white text-sm font-semibold">Email Sent</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8 glass-card rounded-2xl p-6 border border-white/10">
                  <div className="text-center mb-4">
                    <div className="text-white font-semibold">Automated Workflow</div>
                    <div className="text-gray-400 text-sm">Sequences → Analytics → Meetings Booked</div>
                  </div>
                  <div className="flex items-center justify-center gap-4">
                    {['Sequences', 'Analytics', 'Meetings'].map((step, idx) => (
                      <div key={step} className="flex items-center">
                        <div className="text-center">
                          <div className="w-12 h-12 bg-gradient-to-br from-blue-500/20 to-blue-600/20 border border-blue-500/30 rounded-xl flex items-center justify-center mb-2">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-20">
              <div className="inline-flex items-center gap-2 px-6 py-3 glass-card rounded-full mb-8 border-2 border-orange-500/40 hover:scale-105 transition-all duration-300">
                ...
                <span className="text-white font-bold text-sm tracking-wide">THE PROBLEM NOBODY TALKS ABOUT</span>
              </div>

              {/* SIMPLIFIED HEADLINE - LESS COPY */}
              <h2 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-white mb-12 leading-tight tracking-tight">
              ...
              <div className="max-w-5xl mx-auto mb-12">
                <div className="glass-card rounded-3xl p-12 border-2 border-red-500/30 bg-red-500/5">
                  ...
                  <p className="text-xl text-gray-300 leading-relaxed mb-6">
                    The same leads you spent <span className="text-white font-bold">£200-£5,000 each</span> to acquire are now booking meetings with your competitors—at the exact moment they're ready to buy.
                  </p>
                  <p className="text-lg text-red-300 font-semibold">
                    While you're chasing shiny new leads, they're closing deals with YOUR old prospects.
                  </p>
                </div>
              </div>

              {/* STREAMLINED CONTENT - 40% SHORTER */}
              <div className="max-w-5xl mx-auto space-y-8 mb-12">

                <div className="grid md:grid-cols-3 gap-8">
                  <div className="text-center">
                    <div className="text-6xl font-black bg-gradient-to-br from-red-400 to-red-600 bg-clip-text text-transparent mb-4">
                      £<AnimatedStat end={500} decimals={0} />K
                    </div>
                    <div className="text-white font-bold text-lg mb-2">Worth of Leads</div>
                    <div className="text-gray-400 text-sm">Sitting dormant in your CRM</div>
                  </div>
                  <div className="text-center">
                    <div className="text-6xl font-black bg-gradient-to-br from-orange-400 to-orange-600 bg-clip-text text-transparent mb-4">
                      85%
                    </div>
                    <div className="text-white font-bold text-lg mb-2">Go Silent</div>
                    <div className="text-gray-400 text-sm">After initial engagement</div>
                  </div>
                  <div className="text-center">
                    <div className="text-6xl font-black bg-gradient-to-br from-emerald-400 to-emerald-600 bg-clip-text text-transparent mb-4">
                      £50K+
                    </div>
                    <div className="text-white font-bold text-lg mb-2">Acquisition Cost</div>
                    <div className="text-gray-400 text-sm">Per month in wasted spend</div>
                  </div>
                </div>

                {/* COMPETITOR THREAT - PROMINENTLY DISPLAYED */}
                <div className="glass-card rounded-3xl p-10 border-2 border-red-500/40 bg-gradient-to-br from-red-500/10 to-orange-500/5">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-white">The Hidden Threat</h3>
                      <p className="text-gray-400">What nobody tells you</p>
                    </div>
                  </div>
                  <p className="text-xl md:text-2xl text-white leading-relaxed font-bold">
                    While you're chasing <span className="text-red-400">shiny new leads at £5K/pop</span>, your competitors are re-engaging <span className="text-orange-400">YOUR old prospects</span> at the <span className="text-white">EXACT moment they're ready to buy</span>.
                  </p>
                </div>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-24">
              <div className="inline-flex items-center gap-2 px-6 py-3 glass-card rounded-full mb-8 border-2 border-orange-500/40 hover:scale-105 transition-all duration-300">
                ...
                <span className="text-white font-bold text-sm tracking-wide">HOW REKINDLE WORKS</span>
              </div>

              <h2 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-white mb-12 leading-tight tracking-tight">
                We Get{' '}
                <span className="bg-gradient-to-r from-green-400 via-emerald-500 to-green-600 bg-clip-text text-transparent">15.2% Meeting Rates</span>
                <br />
                <span className="text-3xl md:text-4xl lg:text-5xl">When Industry Gets 6-8%</span>
              </h2>
              ...
              <div className="max-w-5xl mx-auto space-y-8 mb-12">
                <div className="glass-card rounded-3xl p-12 border-2 border-green-500/30 bg-green-500/5">
                  ...
                  <p className="text-xl text-gray-300">
                    While others spam dormant leads with generic emails, we use AI to identify the exact moment prospects are ready to buy—and reach out with personalized messages that get responses.
                  </p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  {[
                    {
                      icon: '📊',
                      title: '15.2% Meeting Rate',
                      desc: 'Verified across 847 leads',
                      color: 'from-green-500 to-emerald-600'
                    },
                    {
                      icon: '⚡',
                      title: '18 Hours Average',
                      desc: 'From upload to first meeting',
                      color: 'from-orange-500 to-orange-600'
                    },
                    {
                      icon: '🎯',
                      title: '2.3x Industry Average',
                      desc: 'Better than competitors',
                      color: 'from-blue-500 to-blue-600'
                    }
                  ].map((stat, idx) => (
                    <div key={stat.title} className="glass-card rounded-2xl p-8 text-center hover:scale-105 transition-all duration-300">
        ...
        <section className="relative py-32 px-4 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            {/* Simplified channel overview */}
            <div className="max-w-5xl mx-auto mb-16">
              <div className="text-center mb-12">
                <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                  We use multiple channels intelligently to maximize reach, ensuring your message gets through regardless of where your leads are most active.
                </p>
              </div>

              <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                {[
                  { name: 'Email', icon: Mail, desc: 'Personalized messaging' },
                  { name: 'SMS', icon: MessageSquare, desc: 'Instant notifications' },
                  { name: 'WhatsApp', icon: MessageCircle, desc: 'Direct communication' },
                  { name: 'LinkedIn', icon: () => <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>, desc: 'Professional networking' },
                  { name: 'Voice', icon: Phone, desc: 'Personal touchpoints' }
                ].map((channel, idx) => (
                  <div
                    key={channel.name}
                    className="glass-premium rounded-2xl p-6 text-center group cursor-pointer linear-grid animate-spring-in relative overflow-hidden"
                    style={{ animationDelay: `${idx * 100}ms`, opacity: 0 }}
                  >
                    {/* Hover glow effect */}
                    <div className="absolute inset-0 bg-gradient-to-br from-orange-500/0 via-orange-500/0 to-orange-500/0 group-hover:from-orange-500/10 group-hover:via-orange-500/5 group-hover:to-transparent transition-all duration-500 rounded-2xl" />

                    {/* Icon with premium animation */}
                    <div className="relative z-10">
                      <div className="w-16 h-16 mx-auto mb-4 rounded-xl bg-gradient-to-br from-orange-500/20 to-orange-600/10 flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                        <channel.icon className="w-8 h-8 text-orange-400 group-hover:text-orange-300 transition-colors duration-300" />
                      </div>
                      <div className="text-white font-bold text-lg mb-2 group-hover:text-orange-300 transition-colors duration-300">{channel.name}</div>
            ...
            <div className="mt-20">
              ...
              <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                {[
                  ...
                  <div
                    key={feature.title}
                    className="group glass-premium rounded-3xl p-8 border-2 border-white/10 hover:border-orange-500/30 animate-spring-in relative overflow-hidden linear-grid"
                    style={{ animationDelay: `${idx * 150}ms`, opacity: 0 }}
                  >
                    {/* Stripe-inspired gradient shine on hover */}
                    <div className="absolute inset-0 bg-gradient-to-br from-white/0 via-white/0 to-white/0 group-hover:from-white/5 group-hover:via-transparent group-hover:to-white/5 transition-all duration-700 pointer-events-none" />

                    {/* Apple-inspired blur orb on hover */}
                    <div className="absolute -top-20 -right-20 w-40 h-40 bg-gradient-radial from-orange-500/0 to-transparent group-hover:from-orange-500/20 blur-3xl transition-all duration-500" />

                    <div className="relative z-10">
                      {/* Icon with Linear-inspired animation */}
                      <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br ${feature.color} opacity-90 mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-lg group-hover:shadow-2xl`}>
                        <feature.icon className="w-8 h-8 text-white" />
                      </div>

                      {/* Typography with premium hover effect */}
                      <h4 className="text-2xl font-bold text-white mb-4 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-orange-400 group-hover:to-orange-600 group-hover:bg-clip-text transition-all duration-500">
                        {feature.title}
                      </h4>
                      <p className="text-gray-400 group-hover:text-gray-300 leading-relaxed text-base transition-colors duration-300">
                        {feature.description}
                      </p>
                    </div>
                  </div>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="text-center mb-20">
              <div className="inline-flex items-center gap-2 px-5 py-2.5 glass-card rounded-full mb-8 hover:scale-105 transition-all duration-300">
                ...
                <span className="text-sm text-white font-semibold tracking-wide">PILOT PROGRAM PRICING</span>
              </div>

              <h2 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-white mb-8 leading-tight tracking-tight">
                Simple, Transparent{' '}
                <span className="bg-gradient-to-r from-green-400 via-emerald-500 to-green-600 bg-clip-text text-transparent">Performance Pricing</span>
              </h2>

              <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-6">
                <span className="text-white font-bold">30 days free.</span> Then pay only <span className="text-orange-400 font-bold">2.5% of your deal value</span> for each meeting we book. <span className="text-emerald-400 font-semibold">No meetings = no performance fee.</span>
              </p>
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-20 max-w-7xl mx-auto">
              {/* Starter Plan */}
              <div className="group glass-premium rounded-3xl p-10 border-2 border-white/10 hover:border-blue-500/30 animate-spring-in relative overflow-hidden linear-grid" style={{ opacity: 0, animationDelay: '0ms' }}>
                {/* Stripe-inspired hover shimmer */}
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/0 via-blue-400/0 to-transparent group-hover:from-blue-500/10 group-hover:via-blue-400/5 transition-all duration-700 pointer-events-none" />

                {/* Apple-inspired glow */}
                <div className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-radial from-blue-500/0 to-transparent group-hover:from-blue-500/20 blur-3xl transition-all duration-700" />
                ...
                <div className="mb-8">
                  <div className="text-5xl md:text-6xl font-black text-[#FF6B35] mb-2">£14.99</div>
                  <div className="text-gray-400 text-lg mb-4">/month after 30 days</div>
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-orange-500/20 border border-orange-500/40 rounded-full mb-4">
                    <span className="text-xs font-black text-orange-400">30 DAYS FREE</span>
                  </div>
                  <p className="text-sm text-gray-400">
                    Performance fee: <span className="text-white font-semibold">2.5% of deal value</span> per meeting
                  </p>
                </div>
                ...
                <ul className="space-y-4 mb-10 text-base">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-300">Up to <span className="text-white font-semibold">500 leads</span>/month</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-green-400 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-300"><span className="text-white font-semibold">Email & SMS</span> outreach</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-green-400 flex-shrink-0 mt-0.5" />
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-green-400 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-300"><span className="text-white font-semibold">Basic analytics</span></span>
                  </li>
                </ul>
                ...
                <p className="text-center text-xs text-gray-500 mt-4">Perfect for small teams</p>
              </div>

              {/* Pro Plan - Most Popular */}
              <div className="group relative rounded-3xl p-10 border-2 border-orange-500/50 animate-spring-in transform lg:scale-105 shadow-[0_20px_80px_rgba(255,107,53,0.5),0_0_60px_rgba(255,107,53,0.3)] hover:shadow-[0_30px_100px_rgba(255,107,53,0.6),0_0_80px_rgba(255,107,53,0.4)] transition-all duration-500 overflow-hidden" style={{ opacity: 0, animationDelay: '150ms' }}>
                {/* Animated gradient background - Stripe inspired */}
                <div className="absolute inset-0 bg-gradient-to-br from-orange-500 via-orange-600 to-orange-500 rounded-3xl animate-premium-gradient" />
                <div className="absolute inset-0 bg-gradient-to-br from-orange-500/90 via-orange-600/90 to-orange-500/90 rounded-3xl" />

                {/* Linear-inspired subtle grid overlay */}
                <div className="absolute inset-0 linear-grid opacity-20" />

                {/* Apple-inspired shimmer on hover */}
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/0 to-transparent group-hover:via-white/20 group-hover:animate-glass-shimmer" />
                ...
                <div className="relative">
                  ...
                  <div className="mb-8">
                    <div className="text-5xl md:text-6xl font-black text-white drop-shadow-[0_0_20px_rgba(255,255,255,0.5)] mb-2">£99.99</div>
                    <div className="text-white/80 text-lg mb-4">/month after 30 days</div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/20 border border-white/40 rounded-full mb-4">
                      <span className="text-xs font-black text-white">30 DAYS FREE + 50% OFF FOREVER</span>
                    </div>
                  ...
                  <ul className="space-y-4 mb-10 text-base text-white">
                    <li className="flex items-start gap-3">
                      ...
                      <span>Up to <span className="font-bold">2,000 leads</span>/month</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 flex-shrink-0 mt-0.5" />
                      <span><span className="font-bold">All 5 channels</span> (Email, SMS, WhatsApp, LinkedIn, Voice)</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 flex-shrink-0 mt-0.5" />
                  ...
                  <p className="text-center text-sm text-white/90 mt-4 font-semibold">Most popular choice</p>
                </div>
              </div>
              ...
              <div className="group glass-card-hover rounded-3xl p-10 border-2 border-white/10 hover:border-purple-500/30 animate-fade-in-up" style={{ opacity: 0, animationDelay: '300ms' }}>
                ...
                <div className="mb-8">
                  <div className="text-5xl md:text-6xl font-black bg-gradient-to-br from-purple-400 to-purple-600 bg-clip-text text-transparent mb-2">£399.99</div>
                  <div className="text-gray-400 text-lg mb-4">/month after 30 days</div>
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-purple-500/20 border border-purple-500/40 rounded-full mb-4">
                    <span className="text-xs font-black text-purple-400">30 DAYS FREE + 50% OFF FOREVER</span>
                  </div>
                  <p className="text-sm text-gray-400">
                    Performance fee: <span className="text-white font-semibold">2.5% of deal value</span> per meeting
                  </p>
                ...
                <ul className="space-y-4 mb-10 text-base">
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-green-400 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-300"><span className="text-white font-semibold">All Pro features</span></span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-green-400 flex-shrink-0 mt-0.5" />
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-green-400 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-300"><span className="text-white font-semibold">Custom AI training</span></span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-green-400 flex-shrink-0 mt-0.5" />
                ...
                <p className="text-center text-xs text-gray-500 mt-4">For large organizations</p>
              </div>
            </div>

            {/* Scarcity Badges - Limited Pilot Access */}
            <div className="max-w-4xl mx-auto mb-16">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-white mb-4">Limited Pilot Access - Act Now</h3>
                <p className="text-gray-300">These exclusive pricing and benefits are only available during pilot phase</p>
              </div>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="glass-card rounded-2xl p-6 border-2 border-red-500/30 text-center hover:scale-105 transition-all duration-300">
                  <div className="text-5xl font-black text-red-400 mb-2 drop-shadow-[0_0_20px_rgba(239,68,68,0.5)]">47</div>
                  <div className="text-white font-semibold mb-1">Spots Remaining</div>
                  <div className="text-sm text-gray-400">Of 200 total pilot slots</div>
                  <div className="text-xs text-red-300 font-bold mt-2">Filling up fast!</div>
                </div>
                <div className="glass-card rounded-2xl p-6 border-2 border-orange-500/30 text-center hover:scale-105 transition-all duration-300">
                  <div className="text-5xl font-black text-orange-400 mb-2 drop-shadow-[0_0_20px_rgba(255,107,53,0.5)]">Dec 31</div>
                  <div className="text-white font-semibold mb-1">Pilot Closes</div>
                  <div className="text-sm text-gray-400">Pricing doubles after</div>
                  <div className="text-xs text-orange-300 font-bold mt-2">Lock in 50% off forever</div>
                </div>
                <div className="glass-card rounded-2xl p-6 border-2 border-green-500/30 text-center hover:scale-105 transition-all duration-300">
                  <div className="text-5xl font-black text-green-400 mb-2 drop-shadow-[0_0_20px_rgba(16,185,129,0.5)]">50%</div>
                  <div className="text-white font-semibold mb-1">Off Forever</div>
                  <div className="text-sm text-gray-400">Grandfathered pricing</div>
                  <div className="text-xs text-green-300 font-bold mt-2">Never pay more</div>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card-hover rounded-3xl p-10 border-2 border-orange-500/30 max-w-5xl mx-auto text-center hover:border-orange-500/50 transition-all duration-500">
              ...
              <h3 className="text-3xl font-bold text-white mb-4">
                Pilot Program Guarantee
              </h3>

              <p className="text-xl text-gray-300 mb-6 leading-relaxed max-w-3xl mx-auto">
                <span className="text-white font-bold">30 days completely free.</span> Then pay only 2.5% of your deal value for each meeting we book. <span className="text-orange-400 font-semibold">No meetings booked = no performance fee.</span> Cancel anytime.
              </p>

              <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
                <div className="glass-card rounded-xl p-4 border border-green-500/30">
                  <div className="text-green-400 font-bold text-lg mb-2">30 Days Free</div>
                  <div className="text-sm text-gray-400">Zero platform fee to start</div>
                </div>
                <div className="glass-card rounded-xl p-4 border border-orange-500/30">
                  <div className="text-orange-400 font-bold text-lg mb-2">2.5% Performance Fee</div>
                  <div className="text-sm text-gray-400">Only when meetings are booked</div>
                </div>
                <div className="glass-card rounded-xl p-4 border border-blue-500/30">
                  <div className="text-blue-400 font-bold text-lg mb-2">Cancel Anytime</div>
                  <div className="text-sm text-gray-400">No long-term commitments</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="relative py-32 px-4 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="text-center mb-20">
              ...
              <p className="text-xl md:text-2xl text-gray-300 max-w-5xl mx-auto leading-relaxed">
                <span className="text-white font-bold">You maintain complete control over your brand, messaging, and data.</span> Every message is drafted by AI, <span className="text-emerald-400 font-semibold">reviewed and approved by you</span>, and sent from <span className="text-white font-bold">your team's email addresses</span>. <span className="text-orange-400 font-semibold">Your brand reputation is protected by enterprise-grade security and compliance.</span>
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-10 mb-20">
              ...
              <div className="group glass-card-hover rounded-3xl p-10 border-2 border-white/10 hover:border-emerald-500/30 animate-fade-in-up" style={{ opacity: 0, animationDelay: '0ms' }}>
                ...
                <p className="text-gray-300 mb-8 text-center leading-relaxed">
                  <span className="text-white font-bold">You own your brand, messaging, and data entirely.</span> Every message is drafted by AI, <span className="text-emerald-400 font-semibold">reviewed and approved by you</span>, and sent from <span className="text-white font-bold">your team's email addresses</span>. Toggle any channel on/off as needed.
                </p>

                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-green-400 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-300">Review and edit every message before sending</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-green-400 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-300">Messages sent from your email addresses</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-green-400 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-300">Full control over channel selection</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-green-400 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-300">Your data remains yours - no third-party access</span>
                  </li>
                </ul>
              </div>
